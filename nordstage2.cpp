...
const QMap<quint8, QString> NordStage2::PROPERTIES = NordStage2::createProperties().properties;
...
NordStage2::Triple NordStage2::createProperties()
{
    ...
    reg(Domains::Effect1TypeDomain(60, "Effect 1 Type"));
    reg(Domains::EffectSourceDomain(61, "Effect 1 Source"));
    reg(Domains::Domain_0_10(62, "Effect 1 Amount"));
    reg(Domains::Domain_0_127(63, "Effect 1 Rate"));
    reg(Domains::StatusDomain(69, "Effect 1 Enabled"));
    reg(Domains::StatusDomain(117, "Effect 1 Master Clock"));
    reg(Domains::Effect1TypeDomain(70, "Effect 2 Type"));
    reg(Domains::EffectSourceDomain(71, "Effect 2 Source"));
    reg(Domains::Domain_0_10(72, "Effect 2 Amount"));
    reg(Domains::Domain_0_127(73, "Effect 2 Rate"));
    reg(Domains::StatusDomain(74, "Effect 2 Enabled"));
    reg(Domains::StatusDomain(118, "Effect 2 Master Clock"));
